 ...
 */
public class AssetRedeemNetworkServiceDeveloperDatabaseFactory implements DealsWithPluginDatabaseSystem, DealsWithPluginIdentity {
     ...
     * @param pluginId
     */
    public AssetRedeemNetworkServiceDeveloperDatabaseFactory(PluginDatabaseSystem pluginDatabaseSystem, UUID pluginId) {
    ...
    public void initializeDatabaseCommunication() throws CantInitializeTemplateNetworkServiceDatabaseException {
        ...
        try {
            ...
            AssetRedeemNetworkServiceDatabaseFactory requestNetworkServiceDatabaseFactory = new AssetRedeemNetworkServiceDatabaseFactory(pluginDatabaseSystem);
